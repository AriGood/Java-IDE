            ...
            private void showPopupMenu(java.awt.event.MouseEvent e) {
                ...
                if (selectedFile.exists()) {
                    if (selectedFile.isFile()) {
                        PopupMenuOperations.createFilePopupMenu(selectedFile, fileTreeO).show(e.getComponent(),
                                e.getX(), e.getY());
                    }
                    else if (selectedFile.isDirectory()) {
                        PopupMenuOperations.createDirectoryPopupMenu(selectedFile, fileTreeO).show(e.getComponent(),
                                e.getX(), e.getY());
                    }
                }
            }
